...
![Create User](../screenshots/user-provisioning/01-create-user.png)
...
![User Details](../screenshots/user-provisioning/02-user-details.png)
...
![User Created](../screenshots/user-provisioning/03-user-created.png)
